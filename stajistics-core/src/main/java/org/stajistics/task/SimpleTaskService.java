...
public class SimpleTaskService implements TaskService {
    ...
    private static final String PROP_CORE_POOL_SIZE = SimpleTaskService.class.getName() + ".corePoolSize";
    private static final int DEFAULT_CORE_POOL_SIZE = 10;

    private static final String PROP_MAX_POOL_SIZE = SimpleTaskService.class.getName() + ".maxPoolSize";
    private static final int DEFAULT_MAX_POOL_SIZE = 20;

    private static final String PROP_KEEP_ALIVE_TIME_SECONDS = SimpleTaskService.class.getName() + ".keepAliveTimeSeconds";
    private static final int DEFAULT_KEEP_ALIVE_TIME_SECONDS = 300;

    private static final String PROP_QUEUE_SIZE = SimpleTaskService.class.getName() + ".queueSize";
