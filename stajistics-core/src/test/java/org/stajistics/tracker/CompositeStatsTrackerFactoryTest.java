...
public class CompositeStatsTrackerFactoryTest {
    ...
    public void testConstructWithNullFactoryMap() {
        try {
            new CompositeStatsTrackerFactory<StatsTracker>(null);
            fail();
    ...
    public void testConstructWithEmptyFactoryMap() {
        Map<String,StatsTrackerFactory<StatsTracker>> map = Collections.emptyMap();
        try {
            new CompositeStatsTrackerFactory<StatsTracker>(map);
            fail();
