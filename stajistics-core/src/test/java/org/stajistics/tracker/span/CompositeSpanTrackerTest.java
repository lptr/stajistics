 ...
 */
public class CompositeSpanTrackerTest extends AbstractCompositeTrackerTestCase<SpanTracker> {

    @Override
    protected CompositeSpanTracker createCompositeStatsTracker(final List<SpanTracker> mockTrackers) {
        return new CompositeSpanTracker(mockTrackers);
    }

    @Override
    protected CompositeSpanTracker createCompositeStatsTracker(final SpanTracker[] mockTrackers) {
        return new CompositeSpanTracker(mockTrackers);
    }
    ...
    public void testIsTracking1() {
        ...
        CompositeSpanTracker cTracker = createCompositeStatsTracker(mockTrackers);
