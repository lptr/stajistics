 ...
 */
public class SingletonTrackerFactoryDecoratorTest extends AbstractStajisticsTestCase {
    ...
    public void setUp() {
        ...
        decorator = new SingletonTrackerFactoryDecorator<Tracker>(mockDelegate, mockEventManager);
    }

    @Test
    public void testConstructWithNullDelegate() {
        try {
            new SingletonTrackerFactoryDecorator<Tracker>(null, mockEventManager);
            fail();
    ...
    public void testConstructWithNullEventManager() {
        try {
            new SingletonTrackerFactoryDecorator<Tracker>(mockDelegate, null);
            fail();
        } catch (NullPointerException npe) {
