...
public class DefaultTrackerLocatorTest extends AbstractStajisticsTestCase {
    ...
    public void setUp() {
        ...
        trackerLocator = new DefaultTrackerLocator(mockConfigManager, mockSessionManager);
    }
    ...
    public void testGetSpanTrackerWithSizeOneKeyArray() {
        ...
        Tracker tracker = trackerLocator.getSpanTracker(new StatsKey[] { mockKey });
        SpanTracker expectedTracker = SpanTracker.FACTORY.createTracker(mockKey, mockSessionManager);
    ...
    public void testGetSpanTrackerWithSizeTwoKeyArray() {
        ...
        Tracker tracker = trackerLocator.getSpanTracker(new StatsKey[] { mockKey, mockKey2 });
    ...
    public void testGetIncidentTrackerWithSizeTwoKeyArray() {
        ...
        Tracker tracker = trackerLocator.getIncidentTracker(new StatsKey[] { mockKey, mockKey2 });
