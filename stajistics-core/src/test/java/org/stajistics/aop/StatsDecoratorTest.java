...
public class StatsDecoratorTest {
    ...
    public void testWrapRunnable() {
        ...
        final Runnable wrappedRunnable = StatsDecorator.wrap(mockRunnable, mockKey);
    ...
    public void testWrapObserver() {
        ...
        final Observer wrappedObserver = StatsDecorator.wrap(mockObserver, mockKey);
    ...
    public void testWrapThreadFactory() {
        ...
        final ThreadFactory wrappedThreadFacrtory = StatsDecorator.wrap(mockThreadFactory, mockKey);
        final Runnable mockRunnable = mockery.mock(Runnable.class);
