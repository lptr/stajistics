...
public class AtomicDoubleTest {
    ...
    @Test
    public void testCompareAndSetWithVariousPrecisions() {
        final double[][] numbers = {
            ...
            { 0.99999999999999999999, 0.00000000000000000001 },
            { 0.999999999999999999999, 0.000000000000000000001 },
            { 0.9999999999999999999999, 0.0000000000000000000001 },
        };

        for (int i = 0; i < numbers.length; i++) {
            AtomicDouble ad = new AtomicDouble();
            ad.set(1.0);
            assertTrue(ad.compareAndSet(numbers[i][0] + numbers[i][1], 2.2));
        }
    }
